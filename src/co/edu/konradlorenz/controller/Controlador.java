...
public class Controlador {
    ...
    public void run() {
        ...
        long numeroCuenta = 423;
        long numeroDocumento = 976123;
        String numeroTarjeta ="89524633" ;
        String pin = "123";
        
       
        Cliente persona = new Cliente(nombre, numeroCuenta, numeroDocumento, numeroTarjeta, pin);
        ...
        boolean salir = false;
        while (!salir) {
            int opcion = vista.mostrarMenu(); //aca supongamos que es lo del gui pues para retirar o hacer deposito
